...
* `00IGLib/11_10_IGLib_nitial`
  ...
  * `00IGLib/25_12_ActiVizFrom18_12` - Created from `00IGLib/11_10_IGLib_nitial`, into which the current `master` branch was merged (commit `27d1ff1d856b5bb2933a29637e4239f792bef942` from **December 29, 2018**). Only things within the `00IGLib/` directory were changed / added / removed on this branch; some adaptation branches may be branched off this branch
